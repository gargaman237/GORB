                ...
                <form method="post" name="personalloanwidget" class="md-form" action="/personal-loan" id="personalloanwidget" novalidate="novalidate">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group "><label class="text-left color-blue" for="LoanAmount">Desired Loan Amount</label><input name="LoanAmount" id="LoanAmount" maxlength="18" class="form-control NumericFormat required" data-d-group="2" value="" aria-required="true" type="tel"></div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div id="PLPersonalDet" style="">
                        ...
                        <div class="row">
                            <div class="col-xs-12 pd-top-2">
                                <label class="check_show"><input name="accept" value="0" type="hidden"><input name="accept" id="accept" class="terms-condition required" data-refid="CoAppDet" checked="checked" value="1" aria-required="true" type="checkbox"><i></i><span></span>    I authorize loanmart.com &amp; its partnering banks to contact me to explain the product &amp; I agree to the <a href="#" target="_blank" rel="nofollow" class="terms-text">Terms and Conditions.</a></label>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    </div>
