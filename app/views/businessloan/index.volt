                ...
                <form method="post" name="personalloanwidget" class="md-form" action="/personal-loan" id="personalloanwidget" novalidate="novalidate">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group ">
                                <label class="text-left color-blue" for="Occupation">Year Of Incorporation/VAT/Service Tax Registration</label>
                                <input name="MonthlyIncome" id="yearOfReg" maxlength="18" class="form-control NumericFormat required Expertonchange valid" data-d-group="2" value="" aria-required="true" aria-invalid="false" type="number" step="any">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <br>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <br>
                            <div class="form-group "><label class="text-left color-blue active" for="MonthlyIncome">Turnover</label>
                                <input name="MonthlyIncome" id="MonthlyIncome" maxlength="18" class="form-control NumericFormat required Expertonchange valid" data-d-group="2" value="" aria-required="true" aria-invalid="false" type="number" step="any"></div>
                        </div>
                    ...
                    <div id="PLPersonalDet" style="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <div class="form-group"><label class="text-left color-blue" for="EmailID">DOB</label><input name="DOB" id="DOB" maxlength="20" class="form-control required" value="" aria-required="true" type=""><span id="dobVal"></span></div>
                            </div>
